...
### [str] augmentation: type of approach for augmentation. Has to be in ['eda','word2vec','wordnet','translation','double_translation']
def dataset_augmentation(csv_path, res_path, nb_sentences=3, augmentation='eda'):
    ...
    if augmentation == 'eda':
        ...
        print(['eda','word2vec','wordnet','translation','double_translation'])
        return
